...
function requireLib() {
  ...
  (function(exports$1) {
    ...
    exports$1.Parser = class {
      ...
      _parse(string) {
        ...
        const flush = (inner) => {
          ...
          if (inner === ")") {
            const sub = new exports$1.Parser(current, this.settings);
      ...
      _subFormula(string, name) {
        ...
        args = args.map((arg) => new exports$1.Parser(arg, this.settings));
    ...
    exports$1.Parser.prototype[internals.symbol] = true;
