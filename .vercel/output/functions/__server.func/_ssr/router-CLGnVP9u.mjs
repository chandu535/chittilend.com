...
instance.use(initReactI18next).init({
  ...
  lng: typeof window !== "undefined" && localStorage.getItem("chittilend-lang") || (typeof navigator !== "undefined" && navigator.language.startsWith("te") ? "te" : "en"),
  fallbackLng: "en",
  supportedLngs: ["en", "te"],
  interpolation: {
    escapeValue: false,
...
const appCss = "/assets/styles-w-1wR2gV.css";
...
const $$splitComponentImporter$d = () => import("./login-DHSrYnnx.mjs");
...
const $$splitComponentImporter$c = () => import("./_authenticated-DWMHHBDh.mjs");
...
const $$splitComponentImporter$b = () => import("./_token-BJRIcq0S.mjs");
const Route$b = createFileRoute("/portal/$token")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./settings-C0XQMrSm.mjs");
const Route$a = createFileRoute("/_authenticated/settings")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./payments-CPIEyM7z.mjs");
...
export {
  ...
  setLanguage as c,
  createSsrRpc as d,
  getDashboardSummary as e,
  getCashflowTimeline as f,
  getPortalData as g,
  getRecentActivity as h,
  getAreaBreakdown as i,
  getBorrowerRanking as j,
  getStatusDistribution as k,
  login as l,
  getMonthlySnapshot as m,
  Route$2 as n,
  Route as o,
  router as r,
  setAuthUser as s,
