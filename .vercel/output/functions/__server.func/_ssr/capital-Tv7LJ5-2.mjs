...
import { B as Button, e as createSsrRpc, t as toast } from "./router-BkdMoR6V.mjs";
...
function CapitalPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(PageSkeleton, { variant: "list" }) : log.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: t("common.noData") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0", children: log.map((entry, index) => {
