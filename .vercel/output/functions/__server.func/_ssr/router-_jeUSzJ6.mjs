...
const common = { "appName": "చిట్టీలెండ్", "save": "సేవ్ చేయండి", "cancel": "రద్దు చేయండి", "delete": "తొలగించండి", "edit": "సవరించండి", "search": "శోధించండి", "filter": "ఫిల్టర్", "loading": "లోడ్ అవుతోంది...", "noData": "డేటా కనుగొనబడలేదు", "confirm": "నిర్ధారించండి", "back": "వెనుకకు", "next": "తదుపరి", "submit": "సమర్పించండి", "close": "మూసివేయండి", "yes": "అవును", "no": "కాదు", "all": "అన్ని", "viewAll": "అన్నీ చూడండి", "actions": "చర్యలు", "status": "స్థితి", "date": "తేదీ", "amount": "మొత్తం", "notes": "గమనికలు", "required": "తప్పనిసరి", "optional": "ఐచ్ఛికం" };
...
const appCss = "/assets/styles-C3vLZY6h.css";
...
const $$splitComponentImporter$d = () => import("./login-Dx2bB4tE.mjs");
...
const $$splitComponentImporter$c = () => import("./_authenticated-BnDEA4ke.mjs");
...
const $$splitComponentImporter$b = () => import("./_token-GPP2PFZ9.mjs");
const Route$b = createFileRoute("/portal/$token")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./settings-ByenEbHb.mjs");
const Route$a = createFileRoute("/_authenticated/settings")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./payments-BNk9lh0Y.mjs");
