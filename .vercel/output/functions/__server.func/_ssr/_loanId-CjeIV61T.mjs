...
import { g as getLoanById } from "./loans-yHsY9u03.mjs";
...
import { P as PaymentMarkModal } from "./PaymentMarkModal-BDEUMPDQ.mjs";
import { d as formatPhone } from "./formatters-khdU1uWq.mjs";
import { n as Route$2 } from "./router-CLGnVP9u.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: clsx(
            ...
            isActionable ? "border-slate-200 hover:border-primary hover:bg-primary/5 cursor-pointer" : "border-slate-100 cursor-default",
