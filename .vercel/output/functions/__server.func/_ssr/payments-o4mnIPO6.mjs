...
import { b as bulkUpdateOverdueStatus, l as listUpcomingPayments, a as listOverduePayments, c as listRecentPayments } from "./payments-za2vx1po.mjs";
...
function PaymentsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(PageSkeleton, { variant: "list" }) : data.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: tab === "overdue" ? t("payments.noOverdue") : t("payments.noUpcoming") }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
