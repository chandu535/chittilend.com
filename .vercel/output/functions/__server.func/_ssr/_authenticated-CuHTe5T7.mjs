...
import { R as Route$d, s as setAuthUser, a as authStore, b as logout } from "./router-De5441r5.mjs";
import { u as useLocalizedName } from "./NameDisplay-B-OL-WuP.mjs";
import { L as LanguageToggle } from "./LanguageToggle-DbiFLiqo.mjs";
...
const navItems = [
  ...
  { to: "/analytics", labelKey: "nav.analytics", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(StatsIcon, {}) },
