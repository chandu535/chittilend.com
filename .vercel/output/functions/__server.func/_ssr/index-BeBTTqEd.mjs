...
import { l as listAreas, a as listBorrowers } from "./borrowers-D3qd7hME.mjs";
import { B as Button } from "./router-CLGnVP9u.mjs";
...
import { N as NameDisplay, u as useLocalizedName } from "./NameDisplay-B5K8GAeS.mjs";
...
function BorrowerCard({ id, name, mobile, area, loanCount }) {
    ...
    Link,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 rounded-full bg-primary/10 text-primary flex items-center justify-center text-sm font-semibold shrink-0", children: displayName.charAt(0).toUpperCase() }),
...
function BorrowersPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { size: "lg" }) }) : result.items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: t("borrowers.noBorrowers"), action: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/borrowers/new", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { children: t("borrowers.newBorrower") }) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sm:hidden space-y-3", children: result.items.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(BorrowerCard, { id: b.id, name: b.name, mobile: b.mobile, area: b.area }, b.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:block overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-slate-100", children: result.items.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-slate-50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 font-medium text-slate-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NameDisplay, { name: b.name }) }),
