...
import { l as listLoans, g as getLoanById } from "./loans-DYAFkugB.mjs";
...
import { N as NameDisplay, u as useLocalizedName } from "./NameDisplay-CsHOu8cU.mjs";
import { B as BorrowerAvatar } from "./BorrowerAvatar-7GLEzzgI.mjs";
import { P as PaymentTimeline } from "./PaymentTimeline-Dr3da7q7.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
                ...
                status === "completed" ? null : paidForCurrentMonth ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 flex items-center justify-center rounded-2xl border border-slate-200 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "h-4 w-4 text-emerald-500", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2.5, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M5 13l4 4L19 7" }) }) }) : nextPayment ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: clsx(
                      ...
                      chipPartial ? "border border-red-200 bg-red-100 text-red-700" : chipOverdue ? "bg-gradient-to-b from-red-500 to-red-600 text-white shadow-[0_2px_8px_rgba(239,68,68,0.4)]" : "bg-gradient-to-b from-emerald-500 to-emerald-600 text-white shadow-[0_2px_8px_rgba(16,185,129,0.35)]"
                    ),
          ...
          open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-slate-50", children: fetching ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { size: "lg" }) }) : details ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-5 pt-4 space-y-4", children: [
