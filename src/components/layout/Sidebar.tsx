...
const sidebarItems: SidebarItem[] = [
  ...
  {
    // Last, because it is not a daily destination. The flag only hides the link; the
    // route's own beforeLoad is what actually refuses a manager who types the URL.
    to: '/bin',
    labelKey: 'nav.bin',
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function Sidebar() {
  ...
  // Every page is readable by both roles except Settings, which is staff-account
  // administration rather than business data.
